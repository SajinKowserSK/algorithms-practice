...
custom_test_case_2 = [5,8,3]

print(left_rotation(5, 4, given_test_case)) # -> [5, 1, 2, 3, 4]
print(left_rotation(2, 1, custom_test_case)) # -> [2, 1]
print(left_rotation(3, 3, custom_test_case_2)) #-> [5, 8, 3]
